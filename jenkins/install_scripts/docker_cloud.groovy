...
//Script obtained and tweaked from here: https://github.com/jenkinsci/docker-plugin/blob/master/docs/attachments/docker-plugin-configuration-script.groovy
...
def templateBaseParameters = [
  ...
  image:                       'dchw/earthly-jenkins:latest',
...
def templateParameters = [
  ...
  // disabled:                 false,
  // instanceCapStr:           '4',
  labelString:                 'docker linux earthly',
